...
if("TRUE" STREQUAL "TRUE")
  set(package2_SOURCE_PREFIX /home/fadhilmch/kthfsdv/src/package2)
  set(package2_DEVEL_PREFIX /home/fadhilmch/kthfsdv/devel)
  set(package2_INSTALL_PREFIX "")
  set(package2_PREFIX ${package2_DEVEL_PREFIX})
else()
  set(package2_SOURCE_PREFIX "")
  set(package2_DEVEL_PREFIX "")
  set(package2_INSTALL_PREFIX /home/fadhilmch/kthfsdv/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'package2' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/fadhilmch/kthfsdv/src/package2/${idir}'.  ${_report}")
    endif()
